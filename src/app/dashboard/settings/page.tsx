...
export default function SettingsPage() {
  ...
  useEffect(() => {
    ...
    if (stored) {
      ...
      setFullName(parsed.full_name || 'Test User');
      setEmail(parsed.email || '');
      setPhone(parsed.phone?.replace('+263', '') || '');
    }
  }, []);
        ...
        <div className={styles.section}>
          <div className={styles.avatarSection}>
            ...
            <div>
              ...
              <p className={styles.avatarRole}>
                {role === 'customer' ? '📦 Customer' : role === 'rider' ? '🚴 Rider' : '🏪 Merchant'}
              </p>
          ...
          <div className={styles.formGrid}>
            <div className="input-group">
              <label className="input-label" htmlFor="settingsName">Full name</label>
              <input
                id="settingsName"
                type="text"
                className="input"
            ...
            <div className="input-group">
              <label className="input-label" htmlFor="settingsPhone">Phone</label>
            ...
            <div className={styles.connectedList}>
              <div className={styles.connectedItem}>
                ...
                <div className={styles.connectedInfo}>
                  ...
                  <div className={styles.connectedStatus}>Not connected</div>
                </div>
        ...
        <div className={styles.section}>
          ...
          <div className={styles.formGrid}>
            <div className="input-group">
              ...
              <input id="currentPw" type="password" className="input" placeholder="Enter current password" />
            </div>
            <div className="input-group">
              <label className="input-label" htmlFor="newPw">New password</label>
              <input id="newPw" type="password" className="input" placeholder="Enter new password" />
            </div>
            <div className="input-group">
              <label className="input-label" htmlFor="confirmPw">Confirm password</label>
              <input id="confirmPw" type="password" className="input" placeholder="Confirm new password" />
            </div>
          </div>
              ...
              <div key={key} className={styles.toggleRow}>
                <div>
                  <div className={styles.toggleLabel}>
                    {key === 'order_updates' ? '📦 Order updates' :
                     key === 'promotions' ? '🎁 Promotions' :
                     key === 'rider_nearby' ? '🚴 Rider nearby alerts' :
                     '⚖️ Dispute updates'}
                  </div>
                  <div className={styles.toggleDesc}>
                    {key === 'order_updates' ? 'Get notified when your order status changes' :
                     key === 'promotions' ? 'Receive promotional offers and discounts' :
                     key === 'rider_nearby' ? 'Alert when a rider is approaching' :
          ...
          <div className={styles.dangerZone}>
            ...
            <div className={styles.dangerCard}>
              <div>
                ...
                <p>Permanently delete your Biker account and all associated data. This cannot be undone.</p>
              </div>
