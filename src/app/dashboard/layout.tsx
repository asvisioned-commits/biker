...
function DashboardLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  const { session, loading, refreshSession, country, setCountry, theme, setTheme, resolvedTheme } = useProfile();
            ...
            <div className={styles.sidebarHeaderActions}>
              ...
              >
                {resolvedTheme === 'dark' ? (
                  ...
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>
                )}
              </button>
